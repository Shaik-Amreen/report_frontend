...
@Component({
  selector: 'app-coclass',
  templateUrl: './coclass.component.html',
  styleUrls: ['./coclass.component.css']
})
export class CoclassComponent implements OnInit {
  ...
  save(){
    ...
    this.http.post<any>('http://localhost:4000/saveco',{data:this.mapping,name:'coclasses'}).subscribe(
